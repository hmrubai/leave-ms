...
import { useBranchListByCompanyIdQuery, useDepartmentSaveOrUpdateMutation } from "../../../../services/departmentApi";

const CreateLeaveBalance = ({ handleClose }) => {
  const { data } = useGetCompanyListQuery();
  const [departmentSaveOrUpdate, res] =
